...
def preprocess(bin_file, image_file, prealigned, align, startx, starty, patchsize, bin_size, n_neighbor):
    ...
    plt.savefig('fig/alignment' + startx + '_' + starty + '_' + patchsize + '_' + patchsize + '.png')
    ...
    plt.savefig('fig/stain_mask' + startx + '_' + starty + '_' + patchsize + '_' + patchsize + '.png')
    ...
    plt.savefig('fig/watershed_labels' + startx + '_' + starty + '_' + patchsize + '_' + patchsize + '.png')
    #adatasub.write('data/Mouse_brain_Adult_5800:8000:900:900.h5ad')
    #print(adatasub)

    adatasub.write('data/spots' + startx + '_' + starty + '_' + patchsize + '_' + patchsize + '.h5ad')
    ...
    with open('data/variable_genes' + startx + '_' + starty + '_' + patchsize + '_' + patchsize + '.txt', 'w') as fw:
    ...
    np.savez_compressed('data/x_train_' + startx + '_' + starty + '_' + patchsize + '_' + patchsize + '.npz', x_train=x_train)
    np.savez_compressed('data/x_train_pos_' + startx + "_" + starty + "_" + patchsize + "_" + patchsize + '.npz', x_train_pos=x_train_pos)
    np.savez_compressed('data/y_train_' + startx + "_" + starty + "_" + patchsize + "_" + patchsize + '.npz', y_train=y_train)
    np.savez_compressed('data/y_binary_train_' + startx + "_" + starty + "_" + patchsize + "_" + patchsize + '.npz', y_binary_train=y_binary_train)
    np.savez_compressed('data/x_test_' + startx + "_" + starty + "_" + patchsize + "_" + patchsize + '.npz', x_test=x_test)
    np.savez_compressed('data/x_test_pos_' + startx + "_" + starty + "_" + patchsize + "_" + patchsize + '.npz', x_test_pos=x_test_pos)
